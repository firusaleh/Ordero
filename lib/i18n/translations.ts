...
export const translations = {
  ar: {
    ...
    dashboard: {
      ...
      trialDescription: 'لديك {{orders}} طلب مجاني متبقي. قم بالترقية الآن للاستمرار في استخدام جميع الميزات.',
  ...
  de: {
    ...
    dashboard: {
      ...
      trialDescription: 'Sie haben noch {{orders}} kostenlose Bestellungen. Upgraden Sie jetzt, um alle Features weiter zu nutzen.',
  ...
  en: {
    ...
    dashboard: {
      ...
      trialDescription: 'You have {{orders}} free orders remaining. Upgrade now to continue using all features.',
